import"./jspdf-Bo0itkfF.js";import{r as qe,u as Ze}from"./xlsx-DFH0qU2H.js";import{r as Je,a as Xe,g as Qe}from"./mammoth-D8566hzF.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))o(a);new MutationObserver(a=>{for(const s of a)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function n(a){const s={};return a.integrity&&(s.integrity=a.integrity),a.referrerPolicy&&(s.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?s.credentials="include":a.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function o(a){if(a.ep)return;a.ep=!0;const s=n(a);fetch(a.href,s)}})();const V="CORALGENZ::MILSPEC_V6::QUANTUM_RESISTANT::ZERO_KNOWLEDGE::883920194821",et=V,tt="CORALGENZ::MILSPEC_V5::ANTI_OFFLINE_CRACKER::ZERO_KNOWLEDGE::774910283419",nt="CORALGENZ::MILSPEC_V4::ANTI_JOHN_THE_RIPPER::ZERO_KNOWLEDGE::992174829104";class v{constructor(){this.algo={name:"AES-GCM",length:256}}static detectDeviceCapabilities(){let t=4,n=4;try{typeof navigator<"u"&&(t=navigator.hardwareConcurrency||4,n=navigator.deviceMemory||4)}catch{}const o=t<=2||n<=2;return{isLowEnd:o,recommendedIterations:o?1e6:2e6,concurrency:t,memory:n}}static async computePayloadHash(t){const n=await window.crypto.subtle.digest("SHA-256",t);return Array.from(new Uint8Array(n)).map(a=>a.toString(16).padStart(2,"0")).join("")}static generateIV(){return window.crypto.getRandomValues(new Uint8Array(12))}static generateSalt(){return window.crypto.getRandomValues(new Uint8Array(32))}static async generateKey(){return window.crypto.subtle.generateKey({name:"AES-GCM",length:256},!0,["encrypt","decrypt","wrapKey","unwrapKey"])}static async deriveKeyFromPassword(t,n,o=2e6,a="SHA-256",s=!0,r=V){const i=new TextEncoder;let c;if(s){const u=r||et,y=i.encode(u),g=i.encode(t),f=new Uint8Array(y.length+g.length);f.set(y,0),f.set(g,y.length);const w=await window.crypto.subtle.importKey("raw",n,{name:"HMAC",hash:"SHA-512"},!1,["sign"]),p=await window.crypto.subtle.sign("HMAC",w,f);c=new Uint8Array(p),f.fill(0),g.fill(0)}else c=i.encode(t);const l=await window.crypto.subtle.importKey("raw",c,"PBKDF2",!1,["deriveKey"]),d=await window.crypto.subtle.deriveKey({name:"PBKDF2",salt:n,iterations:o,hash:a},l,{name:"AES-GCM",length:256},!0,["encrypt","decrypt","wrapKey","unwrapKey"]);return c&&c.fill&&c.fill(0),d}static async deriveKeyAsyncWorker(t,n,o=2e6,a=V){if(typeof Worker<"u"&&typeof Blob<"u"&&typeof URL<"u"&&URL.createObjectURL)try{return await new Promise((s,r)=>{const i=`
                    ...
                    `,c=new Blob([i],{type:"application/javascript"}),l=URL.createObjectURL(c),d=new Worker(l),u=setTimeout(()=>{try{d.terminate(),URL.revokeObjectURL(l)}catch{}r(new Error("Worker key derivation timed out"))},12e3);d.onmessage=async g=>{if(clearTimeout(u),d.terminate(),URL.revokeObjectURL(l),g.data&&g.data.success)try{const f=await window.crypto.subtle.importKey("raw",g.data.rawKey,{name:"AES-GCM",length:256},!0,["encrypt","decrypt","wrapKey","unwrapKey"]);s(f)}catch(f){r(f)}else r(new Error(g.data?.error||"Worker derivation failed"))},d.onerror=g=>{clearTimeout(u),d.terminate(),URL.revokeObjectURL(l),r(g)};const y=new Uint8Array(n);d.postMessage({password:t,salt:y,iterations:o,pepper:a})})}catch{}return this.deriveKeyFromPassword(t,n,o,"SHA-256",!0,a)}static async encryptData(t,n){const o=this.generateIV(),a=await window.crypto.subtle.encrypt({name:"AES-GCM",iv:o},t,n);return{iv:o,ciphertext:a}}static async decryptData(t,n,o){return window.crypto.subtle.decrypt({name:"AES-GCM",iv:n},t,o)}static async exportKey(t){return window.crypto.subtle.exportKey("raw",t)}static async importKey(t){return window.crypto.subtle.importKey("raw",t,{name:"AES-GCM"},!0,["encrypt","decrypt","wrapKey","unwrapKey"])}static async wrapKey(t,n){const o=this.generateIV(),a=await window.crypto.subtle.wrapKey("raw",t,n,{name:"AES-GCM",iv:o});return{iv:o,wrappedData:a}}static async unwrapKey(t,n,o){return window.crypto.subtle.unwrapKey("raw",t,n,{name:"AES-GCM",iv:o},{name:"AES-GCM"},!0,["encrypt","decrypt"])}static async unwrapWithFallback(t,n,o,a,s=2e6){try{const r=await this.deriveKeyFromPassword(n,o,s,"SHA-256",!0,V);return await this.unwrapKey(t,r,a)}catch(r){try{const i=await this.deriveKeyFromPassword(n,o,s,"SHA-256",!0,tt);return await this.unwrapKey(t,i,a)}catch{try{const c=await this.deriveKeyFromPassword(n,o,1e6,"SHA-256",!0,nt);return await this.unwrapKey(t,c,a)}catch{const l=[s,1e6,6e5,1e5];for(const d of l)try{const u=await this.deriveKeyFromPassword(n,o,d,"SHA-256",!1);return await this.unwrapKey(t,u,a)}catch{}throw r}}}}static async getDeviceKey(){const t=localStorage.getItem("sv_device_key");let n;if(t){const o=atob(t),a=new Uint8Array(o.length);for(let s=0;s<o.length;s++)a[s]=o.charCodeAt(s);n=a.buffer}else{const o=await this.generateKey();n=await this.exportKey(o);const a=new Uint8Array(n);let s="";for(let r=0;r<a.byteLength;r++)s+=String.fromCharCode(a[r]);localStorage.setItem("sv_device_key",btoa(s))}return this.importKey(n)}}const ot="SecureVaultDB",rt=1,C="files";function X(){return new Promise((e,t)=>{const n=indexedDB.open(ot,rt);n.onupgradeneeded=o=>{const a=o.target.result;a.objectStoreNames.contains(C)||a.createObjectStore(C,{keyPath:"id"})},n.onsuccess=o=>e(o.target.result),n.onerror=o=>t(o.target.error)})}const I={async saveFile(e){const t=await X();return new Promise((n,o)=>{const r=t.transaction(C,"readwrite").objectStore(C).put(e);r.onsuccess=()=>n(e.id),r.onerror=()=>o(r.error)})},async getAllFiles(){const e=await X();return new Promise((t,n)=>{const s=e.transaction(C,"readonly").objectStore(C).openCursor(),r=[];s.onsuccess=i=>{const c=i.target.result;if(c){const{content:l,...d}=c.value;r.push(d),c.continue()}else t(r)},s.onerror=()=>n(s.error)})},async getFile(e){const t=await X();return new Promise((n,o)=>{const r=t.transaction(C,"readonly").objectStore(C).get(e);r.onsuccess=()=>n(r.result),r.onerror=()=>o(r.error)})},async deleteFile(e){const t=await X();return new Promise((n,o)=>{const r=t.transaction(C,"readwrite").objectStore(C).delete(e);r.onsuccess=()=>n(),r.onerror=()=>o(r.error)})},async updateFile(e){return this.saveFile(e)}};var at=Je(),st=Xe();const it=Qe(st),ie=document.getElementById("file-list");document.getElementById("add-file-btn");const $=document.getElementById("auth-modal"),Re=document.getElementById("viewer"),_=document.getElementById("viewer-download-btn"),D=document.getElementById("file-input");document.getElementById("privacy-curtain");const ct=document.getElementById("theme-toggle"),W=document.getElementById("search-input"),Oe=document.getElementById("sort-select"),lt=document.getElementById("storage-text"),dt=document.getElementById("storage-fill"),Le=document.getElementById("bulk-actions"),pt=document.getElementById("selected-count"),ut=document.getElementById("bulk-delete-btn"),mt=document.getElementById("cancel-select-btn"),he=document.getElementById("info-modal"),oe=document.getElementById("rename-modal"),O=document.getElementById("strength-bar"),B=document.getElementById("strength-text"),yt=document.getElementById("bulk-export-btn"),ce=document.getElementById("recent-section"),le=document.getElementById("recent-scroll"),Q=document.getElementById("drop-zone"),Be=document.getElementById("stat-total"),Se=document.getElementById("stat-images"),Te=document.getElementById("stat-videos"),Ce=document.getElementById("stat-size"),U=document.getElementById("settings-modal"),Ke=document.getElementById("change-pass-modal"),gt=document.getElementById("settings-btn"),ft=document.getElementById("help-btn"),te=document.getElementById("help-modal");let we=null,P=null,N=[],k=new Set,ee=null,K=JSON.parse(localStorage.getItem("sv_recent")||"[]"),ht=null,pe=null,A={},M=null;function G(e,t="",n={}){return new Promise(o=>{const a=document.getElementById("custom-prompt-modal"),s=document.getElementById("prompt-title"),r=document.getElementById("prompt-message"),i=document.getElementById("prompt-input"),c=document.getElementById("prompt-confirm"),l=document.getElementById("prompt-cancel");s.textContent=e,r.textContent=t,i.type=n.inputType||"text",i.placeholder=n.placeholder||"Enter value...",i.value="";const d=()=>{a.close(),c.onclick=null,l.onclick=null,i.onkeydown=null};c.onclick=()=>{const u=i.value;d(),o(u||null)},l.onclick=()=>{d(),o(null)},i.onkeydown=u=>{u.key==="Enter"&&(u.preventDefault(),c.click())},a.showModal(),setTimeout(()=>i.focus(),100)})}function j(e,t=""){return new Promise(n=>{const o=document.getElementById("custom-confirm-modal"),a=document.getElementById("confirm-title"),s=document.getElementById("confirm-message"),r=document.getElementById("confirm-ok"),i=document.getElementById("confirm-cancel");a.textContent=e,s.textContent=t;let c=!1;const l=()=>{o.close(),r.onclick=null,i.onclick=null,o.removeEventListener("click",d),o.removeEventListener("close",u)},d=y=>{y.target===o&&!c&&(c=!0,l(),n(!1))},u=()=>{c||(c=!0,l(),n(!1))};r.onclick=()=>{c||(c=!0,l(),n(!0))},i.onclick=()=>{c||(c=!0,l(),n(!1))},o.addEventListener("click",d),o.addEventListener("close",u),o.showModal()})}function E(e,t=""){return new Promise(n=>{const o=document.getElementById("custom-alert-modal"),a=document.getElementById("alert-title"),s=document.getElementById("alert-message"),r=document.getElementById("alert-ok");a.textContent=e,s.textContent=t;const i=l=>{l.key==="Enter"&&(l.preventDefault(),c(),n())},c=()=>{o.close(),r.onclick=null,document.removeEventListener("keydown",i)};r.onclick=()=>{c(),n()},document.addEventListener("keydown",i),o.showModal()})}async function wt(){localStorage.removeItem("sv_app_lock"),localStorage.removeItem("sv_autolock"),localStorage.removeItem("sv_recovery_q"),localStorage.removeItem("sv_recovery_a"),Bt(),ge(),await S(),Et(),Qt(),ze(),Ee(),en()}wt();function b(e){const t=document.getElementById("security-terminal-body");if(t){const n=document.createElement("p");n.className="term-line",n.textContent=`> ${e}`,t.appendChild(n),t.scrollTop=t.scrollHeight}}function x(e,t="completed"){const n=document.getElementById(e);if(n){n.className=`process-step ${t}`.trim();const o=n.querySelector(".step-icon");o&&(t==="completed"?o.textContent="[✓]":t==="active"?o.textContent="[→]":o.textContent="[ ]")}}function F(e,t){const n=document.getElementById("protect-progress-bar"),o=document.getElementById("protect-progress-percent"),a=document.getElementById("protect-progress-label");n&&(n.style.width=`${e}%`),o&&(o.textContent=`${e}%`),a&&t&&(a.textContent=t)}function vt(){const e="ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz23456789!@#$%^&*()_+",t=new Uint8Array(24);window.crypto.getRandomValues(t);let n="";for(let a=0;a<24;a++)n+=e[t[a]%e.length];const o=document.getElementById("new-password");if(o){o.value=n,o.type="text",_e();const a=document.getElementById("toggle-new-password");a&&(a.innerHTML='<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path><line x1="1" y1="23" x2="23" y2="1"></line></svg>',a.style.color="var(--cyber-cyan)")}}function Et(){document.getElementById("cancel-add").addEventListener("click",()=>{z()}),document.getElementById("confirm-add").addEventListener("click",De),document.getElementById("generate-pwd-btn")?.addEventListener("click",vt);const e=document.getElementById("toggle-new-password"),t=document.getElementById("new-password");e?.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation(),t&&(t.type==="password"?(t.type="text",e.innerHTML='<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path><line x1="1" y1="23" x2="23" y2="1"></line></svg>',e.style.color="var(--cyber-cyan)"):(t.type="password",e.innerHTML='<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>',e.style.color="var(--cyber-text-muted)"))}),t?.addEventListener("keydown",r=>{r.key==="Enter"&&(r.preventDefault(),De())}),document.getElementById("download-protected-html-btn")?.addEventListener("click",async()=>{if(!M||!M.record){E("Notice","No active protected file session. Please select a file from the vault below to download.");return}const r=document.getElementById("download-protected-html-btn"),i=r?r.innerHTML:"";try{r&&(r.disabled=!0,r.innerHTML=`
...
`)||"Slide Content"})}let i=0;const c=document.createElement("div");c.className="ppt-viewer";const l=document.createElement("div");l.className="ppt-slide-card";const d=u=>{const y=s[u];l.innerHTML=`
    ...
    `}}function Lt(){document.querySelectorAll("dialog.modal").forEach(t=>{t.addEventListener("click",n=>{const o=t.getBoundingClientRect();n.clientX>=o.left&&n.clientX<=o.right&&n.clientY>=o.top&&n.clientY<=o.bottom,n.target===t&&(t.close(),t.id==="add-modal"&&z())})})}function Bt(){localStorage.getItem("sv_theme")==="light"&&document.body.classList.add("light-theme")}function He(){document.body.classList.toggle("light-theme");const e=document.body.classList.contains("light-theme");localStorage.setItem("sv_theme",e?"light":"dark")}function _e(){const e=document.getElementById("new-password")?.value||"",n=["123456","password","12345678","admin","admin123","benz","qwerty","123456789","welcome","letmein","monkey","dragon","master","football","access","iloveyou","testing","security","vault","pass123"].includes(e.toLowerCase().trim());let o=0;e.length>=8&&o++,e.length>=12&&o++,e.length>=18&&o++,/[A-Z]/.test(e)&&/[a-z]/.test(e)&&o++,/[0-9]/.test(e)&&o++,/[^A-Za-z0-9]/.test(e)&&o++,n&&(o=1),O&&B&&(O.className="strength-bar",e?o<=2||n?(O.classList.add("weak"),B.innerText=n?"VULNERABLE (DICTIONARY WORD)":"WEAK (GPU CRACKABLE)",B.style.color="#ef4444"):o===3||o===4?(O.classList.add("fair"),B.innerText="MODERATE (RECOMMEND 12+ CHARS)",B.style.color="#f59e0b"):o===5?(O.classList.add("good"),B.innerText="STRONG (GPU RESISTANT)",B.style.color="#0284c7"):(O.classList.add("strong"),B.innerText="MIL-SPEC // QUANTUM RESISTANT",B.style.color="#10b981"):(B.innerText="ENTER PASSWORD",B.style.color="var(--cyber-text-muted)",O.style.width="0%"))}function St(){const e=W.value.toLowerCase().trim();S(e)}function Tt(){S(W?.value||"")}function Ct(e){const t=e.reduce((r,i)=>r+(i.size||0),0),n=(t/1024/1024).toFixed(2);lt.innerText=`${e.length} files • ${n} MB used`;const o=Math.min(t/(500*1024*1024)*100,100);dt.style.width=o+"%";const a=e.filter(r=>r.type?.startsWith("image")).length,s=e.filter(r=>r.type?.startsWith("video")).length;Be&&(Be.innerText=e.length),Se&&(Se.innerText=a),Te&&(Te.innerText=s),Ce&&(Ce.innerText=n)}function Y(){const e=document.getElementById("select-all-btn");k.size>0?(Le.classList.remove("hidden"),pt.innerText=`${k.size} selected`,e&&(k.size>=N.length&&N.length>0?e.innerText="Deselect All":e.innerText="Select All")):Le.classList.add("hidden")}function At(){k.size>=N.length&&N.length>0?k.clear():N.forEach(e=>k.add(e.id)),Y(),S(W?.value||"")}function Pt(){k.clear(),Y(),S(W?.value||"")}async function Mt(){if(await j("Delete Files",`Delete ${k.size} file(s)? This cannot be undone.`)){for(const t of k)await I.deleteFile(t);k.clear(),Y(),S(),await E("Success","Files deleted.")}}async function Dt(){if(k.size!==0){await E("Export",`Exporting ${k.size} files. Each will download separately.`);for(const e of k)await I.getFile(e)&&await Nt(e);k.clear(),Y(),S()}}async function Nt(e){const t=await I.getFile(e);if(!t)return;const n=await Z(t);if(!n||!n.buffer)return;const{buffer:o,password:a}=n;let s=a;s||(s=await G("Export Protected File","Enter the file's password to protect this export:",{inputType:"password",placeholder:"Enter original password..."})),s&&await q(t,o,s,{},"Protected file downloaded successfully!")}function Rt(){const e=document.getElementById("app");["dragenter","dragover"].forEach(t=>{e?.addEventListener(t,n=>{n.preventDefault(),Q?.classList.remove("hidden"),Q?.classList.add("active")})}),["dragleave","drop"].forEach(t=>{e?.addEventListener(t,n=>{n.preventDefault(),Q?.classList.add("hidden"),Q?.classList.remove("active")})}),e?.addEventListener("drop",async t=>{t.preventDefault();const n=t.dataTransfer?.files;if(n&&n.length>0)if(n.length===1){const o=new DataTransfer;o.items.add(n[0]),D.files=o.files,Fe(),document.getElementById("inline-add-container")?.scrollIntoView({behavior:"smooth"})}else for(const o of n)await Ot(o)})}async function Ot(e){if(e.size>157286400){await E("File Too Large",`File "${e.name}" is too large. Max 150 MB.`);return}const n=await G("Set Password",`Set password for: ${e.name}`,{inputType:"password",placeholder:"Enter secure password..."});if(!n)return;const o=await v.generateKey(),a=v.generateSalt(),s=await v.deriveKeyFromPassword(n,a,2e6),r=await e.arrayBuffer(),{iv:i,ciphertext:c}=await v.encryptData(o,r),{iv:l,wrappedData:d}=await v.wrapKey(o,s),u={id:crypto.randomUUID(),name:e.name,type:e.type,size:e.size,date:Date.now(),authMode:"always",keys:[{type:"password",salt:a,iv:l,data:d}],content:c,iv:i,viewCount:0};await I.saveFile(u),S(),await E("Success",`${e.name} encrypted and saved!`)}function Kt(){document.addEventListener("keydown",e=>{(e.ctrlKey||e.metaKey)&&e.key==="n"&&e.preventDefault(),(e.ctrlKey||e.metaKey)&&e.key==="f"&&(e.preventDefault(),W?.focus()),e.key==="Escape"&&(z(),$.close(),he?.close(),oe?.close()),(e.ctrlKey||e.metaKey)&&e.shiftKey&&e.key.toLowerCase()==="p"&&(e.preventDefault(),fe()),(e.ctrlKey||e.metaKey)&&e.key==="t"&&(e.preventDefault(),He())})}const Ae=5,Ft=300*1e3;function Ue(e){const t=A[e];if(t&&t.locked&&Date.now()<t.lockedUntil){const n=Math.ceil((t.lockedUntil-Date.now())/1e3);return alert(`File locked. Try again in ${n} seconds.`),!0}return!1}function Ht(e){A[e]||(A[e]={count:0,locked:!1,lockedUntil:0}),A[e].count++;const t=Ae-A[e].count,n=document.getElementById("attempts-left"),o=document.getElementById("auth-attempts");t<=3&&(o?.classList.remove("hidden"),n&&(n.innerText=t)),A[e].count>=Ae&&(A[e].locked=!0,A[e].lockedUntil=Date.now()+Ft,$.close(),alert("Too many failed attempts. File locked for 5 minutes."))}function _t(e){delete A[e],document.getElementById("auth-attempts")?.classList.add("hidden")}async function Ut(){const e=document.getElementById("current-password").value,t=document.getElementById("new-password-change").value,n=document.getElementById("confirm-password-change").value;if(!e||!t||!n){await E("Required","Please fill all fields");return}if(t!==n){await E("Error","New passwords do not match");return}const o=["123456","password","12345678","admin","admin123","benz","qwerty","123456789","welcome","letmein","monkey","dragon","master","football","access","iloveyou","testing","security","vault","pass123","root","user","111111","000000","trustno1"],a=t.toLowerCase().trim();if(!((t.length<8||o.includes(a))&&!await j("⚠️ Weak Password Warning",`This password is short or common, which makes it less secure against offline dictionary attacks. However, Coralgenz Vault still protects it with 2,000,000 PBKDF2 rounds.

Do you want to proceed with this password?`)))try{const r=await I.getFile(ht);if(!r)throw new Error("File not found");const i=r.keys.find(g=>g.type==="password");if(!i)throw new Error("No password key found");const c=await v.unwrapWithFallback(i.data,e,i.salt,i.iv),l=v.generateSalt(),d=await v.deriveKeyFromPassword(t,l,2e6),{iv:u,wrappedData:y}=await v.wrapKey(c,d);r.keys=r.keys.filter(g=>g.type!=="password"),r.keys.push({type:"password",salt:l,iv:u,data:y}),r.accessLog=r.accessLog||[],r.accessLog.push({action:"password_changed",date:Date.now()}),await I.updateFile(r),Ke?.close(),await E("Success","Password changed successfully!")}catch(r){console.error(r),await E("Error","Failed to change password. Current password may be incorrect.")}}function zt(e,t){e.accessLog=e.accessLog||[],e.accessLog.push({action:t,date:Date.now()}),e.accessLog.length>20&&(e.accessLog=e.accessLog.slice(-20))}function Wt(e){K=K.filter(t=>t.id!==e.id),K.unshift({id:e.id,name:e.name,type:e.type,date:Date.now()}),K.length>5&&(K=K.slice(0,5)),localStorage.setItem("sv_recent",JSON.stringify(K)),ze()}function ze(){if(!ce||!le)return;const e=K.filter(t=>N.some(n=>n.id===t.id));if(e.length===0){ce.classList.add("hidden");return}ce.classList.remove("hidden"),le.innerHTML=e.map(t=>`
    <div class="recent-item" data-id="${t.id}">
      <span>${t.type?.startsWith("image")?"🖼️":t.type?.startsWith("video")?"🎬":"📄"}</span>
      <span>${t.name}</span>
    </div>
  `).join(""),le.querySelectorAll(".recent-item").forEach(t=>{t.onclick=()=>me(t.dataset.id)})}async function Vt(e,t){e.stopPropagation(),await j("Delete File","Delete this file permanently?")&&(await I.deleteFile(t),S())}async function $t(e,t){e.stopPropagation();const n=N.find(s=>s.id===t);if(!n)return;document.getElementById("info-name").innerText=n.name,document.getElementById("info-type").innerText=n.type||"Unknown",document.getElementById("info-size").innerText=(n.size/1024/1024).toFixed(2)+" MB",document.getElementById("info-date").innerText=new Date(n.date).toLocaleDateString(),document.getElementById("info-mode").innerText=n.authMode==="always"?"Always Ask Password":n.authMode||"Always Ask Password";const o=document.getElementById("info-views");o&&(o.innerText=n.viewCount||0);const a=document.getElementById("access-log");a&&n.accessLog&&n.accessLog.length>0?a.innerHTML=n.accessLog.slice(-10).reverse().map(s=>`
      <div class="access-log-item">
        ${s.action.replace("_"," ")} - ${new Date(s.date).toLocaleString()}
      </div>
    `).join(""):a&&(a.innerHTML="No access history"),he.showModal()}function Gt(e,t,n){e.stopPropagation(),ee=t;const o=document.getElementById("rename-input");o.value=n,oe.showModal(),setTimeout(()=>{o.focus(),o.select()},100)}async function Pe(){const e=document.getElementById("rename-input").value.trim();if(!e||!ee)return;const t=await I.getFile(ee);t&&(t.name=e,await I.updateFile(t)),oe.close(),ee=null,S()}async function jt(e,t){e&&e.stopPropagation();try{const n=await I.getFile(t);if(!n){await E("Error","File not found");return}const o=await Z(n);if(!o||!o.buffer)return;const{buffer:a,password:s}=o;let r=s;if(r||(r=await G("Download Protected File","Enter the file's password to protect this download:",{inputType:"password",placeholder:"Enter original password..."})),!r)return;await q(n,a,r,{},"Downloaded! The protected file has been saved."),zt(n,"downloaded"),await I.updateFile(n)}catch(n){console.error(n),await E("Error","Failed to download file: "+(n.message||"Decryption error"))}}async function Yt(e,t){e.stopPropagation();try{const n=await I.getFile(t);if(!n)return;const o=await Z(n);if(!o||!o.buffer)return;const{buffer:a,password:s}=o;let r=s;if(r||(r=await G("Share File","Enter the file's password to protect this export:",{inputType:"password",placeholder:"Enter original password..."})),!r)return;await q(n,a,r,{})}catch(n){console.error(n),await E("Error","Share failed: "+n.message)}}function qt(e,t){e.stopPropagation(),pe=t,document.getElementById("share-password").value="",document.getElementById("share-title").value="",document.getElementById("share-logo").value="",document.getElementById("share-modal")?.showModal()}async function Me(){const e=document.getElementById("share-modal"),t=document.getElementById("share-password").value,n=document.getElementById("share-title").value||"SecureVault",o=document.getElementById("share-logo");if(!t){await E("Required","Please set a password for the file.");return}const a=["123456","password","12345678","admin","admin123","benz","qwerty","123456789","welcome","letmein","monkey","dragon","master","football","access","iloveyou","testing","security","vault","pass123","root","user","111111","000000","trustno1"],s=t.toLowerCase().trim();if((t.length<8||a.includes(s))&&!await j("⚠️ Weak Password Warning",`This password is short or common, which makes it less secure against offline dictionary attacks. However, Coralgenz Vault still protects it with 2,000,000 PBKDF2 rounds.

Do you want to proceed with this password?`))return;const i=document.getElementById("confirm-share"),c=i.innerText;i.innerText="Exporting...";try{const l=await I.getFile(pe);if(!l)throw new Error("File not found");const d=await Z(l,t);if(!d||!d.buffer)throw new Error("Decryption failed");const u=d.buffer;let y="";o.files&&o.files[0]&&(y=await new Promise(f=>{const w=new FileReader;w.onload=()=>f(w.result),w.readAsDataURL(o.files[0])})),await q(l,u,t,{title:n,logoUrl:y}),e.close(),pe=null}catch(l){console.error(l),await E("Error","Export failed: "+l.message)}finally{i.innerText=c}}function Zt(e,t){const n=(t||"").toLowerCase(),o=(e||"").toLowerCase();return n.startsWith("image/")||n.startsWith("video/")||n.startsWith("audio/")?!0:/\.(jpg|jpeg|png|gif|webp|svg|bmp|ico|mp4|webm|mov|mkv|ogg|mp3|wav|aac|m4a|flac)$/i.test(o)}function We(){const e=localStorage.getItem("sv_dl_media")!=="false",t=localStorage.getItem("sv_dl_doc")!=="false";return{allowMedia:e,allowDoc:t}}function ve(e,t){const{allowMedia:n,allowDoc:o}=We();return Zt(e,t)?n:o}function ue(){const{allowMedia:e,allowDoc:t}=We(),n=document.getElementById("dl-media-status-badge"),o=document.getElementById("dl-doc-status-badge");n&&(n.textContent=e?"ALLOWED":"RESTRICTED",n.className=`policy-status-badge ${e?"allowed":"restricted"}`),o&&(o.textContent=t?"ALLOWED":"RESTRICTED",o.className=`policy-status-badge ${t?"allowed":"restricted"}`)}async function q(e,t,n,o={},a=""){if(!t||t.byteLength===0)throw new Error("No decrypted file payload available to package.");if(!n)throw new Error("Protection password is required to export this file.");const s=o.allowDownload!==void 0?!!o.allowDownload:ve(e.name,e.type),r=v.generateSalt(),i=await v.computePayloadHash(t),c=await v.deriveKeyAsyncWorker(n,r,2e6,v.MILSPEC_ANTI_CRACKER_PEPPER_V6),{iv:l,ciphertext:d}=await v.encryptData(c,t),y=await(T=>new Promise(L=>{const R=new FileReader;R.readAsDataURL(T),R.onloadend=()=>{const H=R.result||"";L(H.split(",")[1]||"")}}))(new Blob([d]));if(!y)throw new Error("Failed to serialize encrypted payload.");const{header:g,footer:f}=Jt(e,r,l,{...o,allowDownload:s,integrityHash:i}),w=new Blob([g,y,f],{type:"text/html;charset=utf-8"}),p=URL.createObjectURL(w),m=document.createElement("a");m.href=p;const h=e.name||"protected_file";m.download=h.endsWith(".secure.html")?h:h+".secure.html",document.body.appendChild(m),m.click(),document.body.removeChild(m),setTimeout(()=>URL.revokeObjectURL(p),6e4)}function Jt(e,t,n,o={}){const a=se=>btoa(String.fromCharCode(...new Uint8Array(se))),s=a(t),r=a(n),i=o.title||"Coralgenz Vault",c=o.logoUrl||"",l=e.name||"Protected File",d=e.type||"application/octet-stream",u=Number(e.size)||0,y=e.id||"",g=o.allowDownload!==void 0?!!o.allowDownload:ve(l,d),f=JSON.stringify(s),w=JSON.stringify(r),p=JSON.stringify(d),m=JSON.stringify(l),h=JSON.stringify(u),T=JSON.stringify(i),L=JSON.stringify(y),R=JSON.stringify(g),H=JSON.stringify(o.integrityHash||e.integrityHash||""),J=JSON.stringify("V6"),re=c?`<img src="${c}" alt="Logo" class="brand-custom-logo">`:`<div class="brand-shield-icon">
...
<body>
    ...
    <script>
        ...
        const ATTEMPTS_KEY = 'cg_fails_' + ${L};
        const LOCKOUT_KEY = 'cg_lockout_' + ${L};
...
</html>`}}async function Z(e,t=null){let n=null,o=t;if(t)try{const s=e.keys.find(r=>r.type==="password");s&&(n=await v.unwrapWithFallback(s.data,t,s.salt,s.iv))}catch{console.log("Provided password invalid for unlock")}if(!n){const s=await G("Decrypt for Export","Provide the ORIGINAL password to decrypt for export:",{inputType:"password",placeholder:"Enter password..."});if(!s)return null;try{const r=e.keys.find(i=>i.type==="password");n=await v.unwrapWithFallback(r.data,s,r.salt,r.iv),o=s}catch{return await E("Error","Incorrect password"),null}}return{buffer:await v.decryptData(n,e.iv,e.content),password:o}}async function De(){const e=D.files[0],t=document.getElementById("new-password").value;if(!e){await E("Required","Please select a file to protect");return}if(!t){await E("Required","Protection password is required");return}const n=["123456","password","12345678","admin","admin123","benz","qwerty","123456789","welcome","letmein","monkey","dragon","master","football","access","iloveyou","testing","security","vault","pass123","root","user","111111","000000","trustno1"],o=t.toLowerCase().trim();if((t.length<8||n.includes(o))&&!await j("⚠️ Weak Password Warning",`This password is short or common, which makes it less secure against offline dictionary attacks. However, Coralgenz Vault still protects it with 2,000,000 PBKDF2 rounds.

Do you want to proceed with this password?`))return;const s=document.getElementById("confirm-add"),r=s.innerText;s.innerText="SECURING PAYLOAD...",s.disabled=!0;const i=document.getElementById("protection-process-container"),c=document.getElementById("file-upload-zone"),l=document.getElementById("file-preview"),d=document.getElementById("inline-password-section"),u=document.getElementById("protection-complete-container"),y=document.getElementById("security-terminal-body"),g=document.getElementById("process-timer-display"),f=document.getElementById("scanner-status-text"),w=document.querySelector(".scanner-center-shield");c?.classList.add("hidden"),l?.classList.add("hidden"),d?.classList.add("hidden"),u?.classList.add("hidden"),i?.classList.remove("hidden"),["step-analysis","step-prep","step-kdf","step-encrypt","step-meta","step-finalize","step-output","step-verify"].forEach(h=>{x(h,"")}),w&&w.classList.remove("success"),f&&(f.textContent="SECURING"),y&&(y.innerHTML="");const p=Date.now(),m=setInterval(()=>{const h=Date.now()-p,T=Math.floor(h/1e3).toString().padStart(2,"0"),L=Math.floor(h%1e3/10).toString().padStart(2,"0");g&&(g.textContent=`00:${T}.${L}`)},20);try{F(14,"FILE STRUCTURE ANALYSIS // MEMORY ENCLAVE..."),x("step-analysis","active"),b("[00:00.02] INITIATING ENCRYPTION PIPELINE // ZERO-KNOWLEDGE V2.6"),b(`[00:00.04] File: "${e.name}" [${ne(e.size)}] | Type: ${e.type||"application/octet-stream"}`),b(`[00:00.06] Enclave memory block allocated: ${e.size} bytes. Isolation confirmed.`);const h=v.detectDeviceCapabilities();b(`[00:00.08] Hardware Profile: ${h.concurrency} Cores, ${h.memory}GB RAM [Worker Offload: Active]`),x("step-analysis","completed"),F(28,"INITIALIZING CSPRNG ENTROPY POOL..."),x("step-prep","active"),b("[00:00.10] Generating 256-bit cryptographic salt from hardware CSPRNG...");const T=v.generateSalt(),L=await v.generateKey();b("[00:00.12] Nonce generation: 96-bit AES-GCM Initialization Vector created."),b("[00:00.14] Ephemeral entropy validated: entropy score = 0.998."),x("step-prep","completed"),F(45,"DERIVING KEY (DUAL-STAGE KDF 2,000,000 ROUNDS)..."),x("step-kdf","active"),b("[00:00.16] Stage 1: HMAC-SHA512 Pre-whitening with Domain-Separated Pepper V6..."),b("[00:00.18] Worker Offload: Initializing background thread for smooth 60fps UI..."),b("[00:00.20] Stage 2: Computing 2,000,000 PBKDF2 iterations (Anti-JohnTheRipper / Anti-Hashcat)...");const R=await v.deriveKeyAsyncWorker(t,T,2e6,v.MILSPEC_ANTI_CRACKER_PEPPER_V6);b("[00:00.22] Key derivation complete: 256-bit symmetric cipher key established."),x("step-kdf","completed"),F(65,"AES-GCM-256 CIPHER STREAM PROCESSING..."),x("step-encrypt","active"),b("[00:00.24] Executing client-side WebCrypto AES-GCM 256-bit cipher...");const H=await e.arrayBuffer(),J=await v.computePayloadHash(H);b(`[00:00.26] SHA-256 Payload Integrity Seal: ${J.substring(0,16)}... [VERIFIED]`);const re=H.slice(0),{iv:be,ciphertext:ae}=await v.encryptData(L,H);b(`[00:00.28] Encrypting ${ne(e.size)} payload blocks into zero-knowledge ciphertext...`),b(`[00:00.30] Ciphertext generated (${ae.byteLength} bytes). 128-bit Galois Tag verified.`),x("step-encrypt","completed"),F(80,"PACKAGING ZERO-KNOWLEDGE METADATA..."),x("step-meta","active"),x("step-finalize","active"),b("[00:00.32] Wrapping master file key with AES key wrap cipher...");const{iv:se,wrappedData:Ve}=await v.wrapKey(L,R),$e=[{type:"password",salt:T,iv:se,data:Ve}],xe={id:crypto.randomUUID(),name:e.name,type:e.type,size:e.size,date:Date.now(),authMode:"always",keys:$e,content:ae,iv:be,viewCount:0,expires:null,note:"",integrityHash:J,accessLog:[{action:"created",date:Date.now()}]};await I.saveFile(xe),b("[00:00.34] Encrypted container committed to zero-knowledge local IndexedDB."),x("step-meta","completed"),x("step-finalize","completed"),F(92,"COMPILING STANDALONE HTML RUNTIME (.secure.html)..."),x("step-output","active"),b("[00:00.36] Assembling self-contained portable decryption engine..."),b("[00:00.38] Embedding browser-native WebCrypto decryptor payload..."),b("[00:00.40] Enforced security policy configured: ALWAYS ASK PASSWORD."),x("step-output","completed"),F(100,"CRYPTOGRAPHIC INTEGRITY VERIFIED [SEALED]"),x("step-verify","active"),b("[00:00.42] Authenticity check: GMAC integrity tag valid. Zero-knowledge verification OK."),b("[00:00.44] CRYPTOGRAPHIC CONTAINER LOCKED & SEALED. READY."),x("step-verify","completed"),clearInterval(m);const Ie=Date.now()-p,Ge=Math.floor(Ie/1e3).toString().padStart(2,"0"),je=Math.floor(Ie%1e3/10).toString().padStart(2,"0");g&&(g.textContent=`00:${Ge}.${je}`),f&&(f.textContent="SECURED [✓]"),w&&w.classList.add("success"),await new Promise(Ye=>setTimeout(Ye,120)),i?.classList.add("hidden"),u?.classList.remove("hidden");const ke=document.getElementById("complete-file-name");ke&&(ke.textContent=e.name),M={record:xe,buffer:re,password:t},S()}catch(h){clearInterval(m),console.error(h),b(`CRITICAL ERROR: ${h.message}`),await E("Error","Encryption failed: "+h.message),i?.classList.add("hidden"),l?.classList.remove("hidden"),d?.classList.remove("hidden")}finally{s.innerText=r,s.disabled=!1}}async function me(e){if(!Ue(e))try{const t=await I.getFile(e);if(!t){await E("Error","File not found");return}we=t,document.getElementById("auth-file-name").innerText=t.name,$.showModal()}catch(t){console.error(t),await E("Error","Error opening file")}}async function Ne(){const e=we;if(!e||Ue(e.id))return;const t=document.getElementById("auth-password").value;if(!t)return;const n=document.getElementById("confirm-auth");n.innerText="Unlocking...";try{const o=e.keys.find(s=>s.type==="password");if(!o)throw new Error("Corrupt key data");const a=await v.unwrapWithFallback(o.data,t,o.salt,o.iv);_t(e.id),$.close(),document.getElementById("auth-password").value="",Xt(e,a)}catch(o){console.error(o),Ht(e.id),await E("Error","Incorrect password or decryption error.")}finally{n.innerText="Unlock"}}async function Xt(e,t){try{const n=await v.decryptData(t,e.iv,e.content),o=new Blob([n],{type:e.type});P=URL.createObjectURL(o);const a=document.getElementById("viewer-content");a.innerHTML="";const s=ve(e.name,e.type);_&&(s?(_.classList.remove("hidden"),_.onclick=()=>{if(!P)return;const p=document.createElement("a");p.style.display="none",p.href=P,p.download=e.name,document.body.appendChild(p),p.click(),document.body.removeChild(p)}):(_.classList.add("hidden"),_.onclick=null));const r=(e.name||"").toLowerCase(),i=(e.type||"").toLowerCase(),c=i.startsWith("image/")||/\.(jpg|jpeg|png|gif|webp|svg|bmp|ico)$/i.test(r),l=i.startsWith("video/")||/\.(mp4|webm|mov|mkv|ogg)$/i.test(r),d=i.startsWith("audio/")||/\.(mp3|wav|ogg|aac|m4a|flac)$/i.test(r),u=i==="application/pdf"||/\.pdf$/i.test(r),y=i.includes("excel")||i.includes("spreadsheet")||/\.(xlsx|xls|csv|tsv)$/i.test(r),g=i.includes("word")||/\.(docx|doc)$/i.test(r),f=i.includes("presentation")||i.includes("powerpoint")||/\.(pptx|ppt|pps|ppsx)$/i.test(r),w=i.startsWith("text/")||/\.(txt|json|js|ts|html|css|py|c|cpp|h|java|sh|xml|yaml|yml|sql|md|log|env|rs|go|kt|swift|rb|php)$/i.test(r);if(c){const p=document.createElement("img");p.src=P,p.style.maxWidth="90vw",p.style.maxHeight="80vh",p.style.objectFit="contain",a.appendChild(p)}else if(l||d){const p=document.createElement(l?"video":"audio");p.src=P,p.controls=!0,p.autoplay=!0,s||(p.setAttribute("controlsList","nodownload"),p.oncontextmenu=m=>m.preventDefault()),a.appendChild(p)}else if(u){const p=document.createElement("iframe");p.src=P+(s?"":"#toolbar=0"),p.style.width="100%",p.style.height="100%",p.style.border="none",a.appendChild(p)}else if(y)xt(n,a);else if(g)await It(n,a);else if(f)await kt(n,e.name,a);else if(w){const m=new TextDecoder().decode(n),h=document.createElement("div");h.className="excel-viewer",h.style.background="#0f172a",h.style.color="#e2e8f0",h.innerHTML=`
      ...
      `,a.appendChild(h),h.querySelector("#vault-copy-code-btn")?.addEventListener("click",async()=>{await navigator.clipboard.writeText(m),await E("Success","Text copied to clipboard!")})}else{const p=document.createElement("div");p.className="ppt-slide-card",p.style.alignItems="center",p.style.justifyContent="center",p.style.textAlign="center",p.innerHTML=`
        <div style="font-size:48px;margin-bottom:12px;">📁</div>
        <div class="ppt-slide-title">${e.name}</div>
        <div class="ppt-slide-content" style="color:var(--accent-cyan);font-weight:700;margin-top:6px;">DECRYPTED FILE READY (${ne(e.size)})</div>
      ...
      `,a.appendChild(p)}document.getElementById("viewer-filename").innerText=e.name,Re.classList.remove("hidden"),Wt(e),document.getElementById("viewer-timer").classList.add("hidden")}catch(n){console.error(n),await E("Error","Decryption failed.")}}async function ye(){Re.classList.add("hidden"),_&&_.classList.add("hidden"),document.getElementById("viewer-content").innerHTML="",P&&(URL.revokeObjectURL(P),P=null)}async function Qt(){localStorage.getItem("sv_crash_guard")&&(localStorage.removeItem("sv_crash_guard"),S())}async function S(e=""){ie.innerHTML="";let t=await I.getAllFiles();N=t,Ct(t),e&&(t=t.filter(a=>a.name.toLowerCase().includes(e.toLowerCase())));const n=Oe?.value||"date-desc";t.sort((a,s)=>{if(a.favorite&&!s.favorite)return-1;if(!a.favorite&&s.favorite)return 1;switch(n){case"date-desc":return(s.date||0)-(a.date||0);case"date-asc":return(a.date||0)-(s.date||0);case"name-asc":return a.name.localeCompare(s.name);case"name-desc":return s.name.localeCompare(a.name);case"size-desc":return(s.size||0)-(a.size||0);case"size-asc":return(a.size||0)-(s.size||0);default:return 0}});const o=document.getElementById("quick-tips");if(o&&(N.length===0?o.classList.remove("hidden"):o.classList.add("hidden")),t.length===0){ie.innerHTML=`
    ...
    `,document.body.appendChild(t),document.getElementById("panic-reload-btn")?.addEventListener("click",n=>{n.stopPropagation(),t.remove()})}else if(e==="loading"){ye(),U?.close(),te?.close(),document.querySelectorAll(".panic-overlay").forEach(o=>o.remove());const t=document.createElement("div");t.className="panic-overlay",t.innerHTML=`
