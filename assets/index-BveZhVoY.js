import"./jspdf-Bo0itkfF.js";import{r as Ge,u as je}from"./xlsx-DFH0qU2H.js";import{r as Ye,a as qe,g as Ze}from"./mammoth-D8566hzF.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))o(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function n(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(a){if(a.ep)return;a.ep=!0;const i=n(a);fetch(a.href,i)}})();const $="CORALGENZ::MILSPEC_V6::QUANTUM_RESISTANT::ZERO_KNOWLEDGE::883920194821",Je=$,Xe="CORALGENZ::MILSPEC_V5::ANTI_OFFLINE_CRACKER::ZERO_KNOWLEDGE::774910283419",Qe="CORALGENZ::MILSPEC_V4::ANTI_JOHN_THE_RIPPER::ZERO_KNOWLEDGE::992174829104";class w{constructor(){this.algo={name:"AES-GCM",length:256}}static detectDeviceCapabilities(){let t=4,n=4;try{typeof navigator<"u"&&(t=navigator.hardwareConcurrency||4,n=navigator.deviceMemory||4)}catch{}const o=t<=2||n<=2;return{isLowEnd:o,recommendedIterations:o?1e6:2e6,concurrency:t,memory:n}}static async computePayloadHash(t){const n=await window.crypto.subtle.digest("SHA-256",t);return Array.from(new Uint8Array(n)).map(a=>a.toString(16).padStart(2,"0")).join("")}static generateIV(){return window.crypto.getRandomValues(new Uint8Array(12))}static generateSalt(){return window.crypto.getRandomValues(new Uint8Array(32))}static async generateKey(){return window.crypto.subtle.generateKey({name:"AES-GCM",length:256},!0,["encrypt","decrypt","wrapKey","unwrapKey"])}static async deriveKeyFromPassword(t,n,o=2e6,a="SHA-256",i=!0,r=$){const s=new TextEncoder;let c;if(i){const p=r||Je,g=s.encode(p),f=s.encode(t),y=new Uint8Array(g.length+f.length);y.set(g,0),y.set(f,g.length);const v=await window.crypto.subtle.importKey("raw",n,{name:"HMAC",hash:"SHA-512"},!1,["sign"]),d=await window.crypto.subtle.sign("HMAC",v,y);c=new Uint8Array(d),y.fill(0),f.fill(0)}else c=s.encode(t);const l=await window.crypto.subtle.importKey("raw",c,"PBKDF2",!1,["deriveKey"]),u=await window.crypto.subtle.deriveKey({name:"PBKDF2",salt:n,iterations:o,hash:a},l,{name:"AES-GCM",length:256},!0,["encrypt","decrypt","wrapKey","unwrapKey"]);return c&&c.fill&&c.fill(0),u}static async deriveKeyAsyncWorker(t,n,o=2e6,a=$){if(typeof Worker<"u"&&typeof Blob<"u"&&typeof URL<"u"&&URL.createObjectURL)try{return await new Promise((i,r)=>{const s=`
                    ...
                    `,c=new Blob([s],{type:"application/javascript"}),l=URL.createObjectURL(c),u=new Worker(l),p=setTimeout(()=>{try{u.terminate(),URL.revokeObjectURL(l)}catch{}r(new Error("Worker key derivation timed out"))},12e3);u.onmessage=async f=>{if(clearTimeout(p),u.terminate(),URL.revokeObjectURL(l),f.data&&f.data.success)try{const y=await window.crypto.subtle.importKey("raw",f.data.rawKey,{name:"AES-GCM",length:256},!0,["encrypt","decrypt","wrapKey","unwrapKey"]);i(y)}catch(y){r(y)}else r(new Error(f.data?.error||"Worker derivation failed"))},u.onerror=f=>{clearTimeout(p),u.terminate(),URL.revokeObjectURL(l),r(f)};const g=new Uint8Array(n);u.postMessage({password:t,salt:g,iterations:o,pepper:a})})}catch{}return this.deriveKeyFromPassword(t,n,o,"SHA-256",!0,a)}static async encryptData(t,n){const o=this.generateIV(),a=await window.crypto.subtle.encrypt({name:"AES-GCM",iv:o},t,n);return{iv:o,ciphertext:a}}static async decryptData(t,n,o){return window.crypto.subtle.decrypt({name:"AES-GCM",iv:n},t,o)}static async exportKey(t){return window.crypto.subtle.exportKey("raw",t)}static async importKey(t){return window.crypto.subtle.importKey("raw",t,{name:"AES-GCM"},!0,["encrypt","decrypt","wrapKey","unwrapKey"])}static async wrapKey(t,n){const o=this.generateIV(),a=await window.crypto.subtle.wrapKey("raw",t,n,{name:"AES-GCM",iv:o});return{iv:o,wrappedData:a}}static async unwrapKey(t,n,o){return window.crypto.subtle.unwrapKey("raw",t,n,{name:"AES-GCM",iv:o},{name:"AES-GCM"},!0,["encrypt","decrypt"])}static async unwrapWithFallback(t,n,o,a,i=2e6){try{const r=await this.deriveKeyFromPassword(n,o,i,"SHA-256",!0,$);return await this.unwrapKey(t,r,a)}catch(r){try{const s=await this.deriveKeyFromPassword(n,o,i,"SHA-256",!0,Xe);return await this.unwrapKey(t,s,a)}catch{try{const c=await this.deriveKeyFromPassword(n,o,1e6,"SHA-256",!0,Qe);return await this.unwrapKey(t,c,a)}catch{const l=[i,1e6,6e5,1e5];for(const u of l)try{const p=await this.deriveKeyFromPassword(n,o,u,"SHA-256",!1);return await this.unwrapKey(t,p,a)}catch{}throw r}}}}static async getDeviceKey(){const t=localStorage.getItem("sv_device_key");let n;if(t){const o=atob(t),a=new Uint8Array(o.length);for(let i=0;i<o.length;i++)a[i]=o.charCodeAt(i);n=a.buffer}else{const o=await this.generateKey();n=await this.exportKey(o);const a=new Uint8Array(n);let i="";for(let r=0;r<a.byteLength;r++)i+=String.fromCharCode(a[r]);localStorage.setItem("sv_device_key",btoa(i))}return this.importKey(n)}}const et="SecureVaultDB",tt=1,A="files";function J(){return new Promise((e,t)=>{const n=indexedDB.open(et,tt);n.onupgradeneeded=o=>{const a=o.target.result;a.objectStoreNames.contains(A)||a.createObjectStore(A,{keyPath:"id"})},n.onsuccess=o=>e(o.target.result),n.onerror=o=>t(o.target.error)})}const I={async saveFile(e){const t=await J();return new Promise((n,o)=>{const r=t.transaction(A,"readwrite").objectStore(A).put(e);r.onsuccess=()=>n(e.id),r.onerror=()=>o(r.error)})},async getAllFiles(){const e=await J();return new Promise((t,n)=>{const i=e.transaction(A,"readonly").objectStore(A).openCursor(),r=[];i.onsuccess=s=>{const c=s.target.result;if(c){const{content:l,...u}=c.value;r.push(u),c.continue()}else t(r)},i.onerror=()=>n(i.error)})},async getFile(e){const t=await J();return new Promise((n,o)=>{const r=t.transaction(A,"readonly").objectStore(A).get(e);r.onsuccess=()=>n(r.result),r.onerror=()=>o(r.error)})},async deleteFile(e){const t=await J();return new Promise((n,o)=>{const r=t.transaction(A,"readwrite").objectStore(A).delete(e);r.onsuccess=()=>n(),r.onerror=()=>o(r.error)})},async updateFile(e){return this.saveFile(e)}};var nt=Ye(),ot=qe();const rt=Ze(ot),se=document.getElementById("file-list");document.getElementById("add-file-btn");const V=document.getElementById("auth-modal"),Re=document.getElementById("viewer"),z=document.getElementById("viewer-download-btn"),D=document.getElementById("file-input");document.getElementById("privacy-curtain");const at=document.getElementById("theme-toggle"),W=document.getElementById("search-input"),Oe=document.getElementById("sort-select"),it=document.getElementById("storage-text"),st=document.getElementById("storage-fill"),Le=document.getElementById("bulk-actions"),ct=document.getElementById("selected-count"),lt=document.getElementById("bulk-delete-btn"),dt=document.getElementById("cancel-select-btn"),we=document.getElementById("info-modal"),ne=document.getElementById("rename-modal"),O=document.getElementById("strength-bar"),T=document.getElementById("strength-text"),pt=document.getElementById("bulk-export-btn"),ce=document.getElementById("recent-section"),le=document.getElementById("recent-scroll"),X=document.getElementById("drop-zone"),Be=document.getElementById("stat-total"),Ce=document.getElementById("stat-images"),Te=document.getElementById("stat-videos"),Se=document.getElementById("stat-size"),_=document.getElementById("settings-modal"),Ke=document.getElementById("change-pass-modal"),ut=document.getElementById("settings-btn"),mt=document.getElementById("help-btn"),ee=document.getElementById("help-modal");let ve=null,M=null,R=[],L=new Set,Q=null,K=JSON.parse(localStorage.getItem("sv_recent")||"[]"),yt=null,pe=null,P={},N=null;function G(e,t="",n={}){return new Promise(o=>{const a=document.getElementById("custom-prompt-modal"),i=document.getElementById("prompt-title"),r=document.getElementById("prompt-message"),s=document.getElementById("prompt-input"),c=document.getElementById("prompt-confirm"),l=document.getElementById("prompt-cancel");i.textContent=e,r.textContent=t,s.type=n.inputType||"text",s.placeholder=n.placeholder||"Enter value...",s.value="";const u=()=>{a.close(),c.onclick=null,l.onclick=null,s.onkeydown=null};c.onclick=()=>{const p=s.value;u(),o(p||null)},l.onclick=()=>{u(),o(null)},s.onkeydown=p=>{p.key==="Enter"&&(p.preventDefault(),c.click())},a.showModal(),setTimeout(()=>s.focus(),100)})}function oe(e,t=""){return new Promise(n=>{const o=document.getElementById("custom-confirm-modal"),a=document.getElementById("confirm-title"),i=document.getElementById("confirm-message"),r=document.getElementById("confirm-ok"),s=document.getElementById("confirm-cancel");a.textContent=e,i.textContent=t;let c=!1;const l=()=>{o.close(),r.onclick=null,s.onclick=null,o.removeEventListener("click",u),o.removeEventListener("close",p)},u=g=>{g.target===o&&!c&&(c=!0,l(),n(!1))},p=()=>{c||(c=!0,l(),n(!1))};r.onclick=()=>{c||(c=!0,l(),n(!0))},s.onclick=()=>{c||(c=!0,l(),n(!1))},o.addEventListener("click",u),o.addEventListener("close",p),o.showModal()})}function E(e,t=""){return new Promise(n=>{const o=document.getElementById("custom-alert-modal"),a=document.getElementById("alert-title"),i=document.getElementById("alert-message"),r=document.getElementById("alert-ok");a.textContent=e,i.textContent=t;const s=l=>{l.key==="Enter"&&(l.preventDefault(),c(),n())},c=()=>{o.close(),r.onclick=null,document.removeEventListener("keydown",s)};r.onclick=()=>{c(),n()},document.addEventListener("keydown",s),o.showModal()})}async function gt(){localStorage.removeItem("sv_app_lock"),localStorage.removeItem("sv_autolock"),localStorage.removeItem("sv_recovery_q"),localStorage.removeItem("sv_recovery_a"),It(),fe(),await S(),ht(),Zt(),_e(),be(),Jt()}gt();function b(e){const t=document.getElementById("security-terminal-body");if(t){const n=document.createElement("p");n.className="term-line",n.textContent=`> ${e}`,t.appendChild(n),t.scrollTop=t.scrollHeight}}function x(e,t="completed"){const n=document.getElementById(e);if(n){n.className=`process-step ${t}`.trim();const o=n.querySelector(".step-icon");o&&(t==="completed"?o.textContent="[✓]":t==="active"?o.textContent="[→]":o.textContent="[ ]")}}function F(e,t){const n=document.getElementById("protect-progress-bar"),o=document.getElementById("protect-progress-percent"),a=document.getElementById("protect-progress-label");n&&(n.style.width=`${e}%`),o&&(o.textContent=`${e}%`),a&&t&&(a.textContent=t)}function ft(){const e="ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz23456789!@#$%^&*()_+",t=new Uint8Array(24);window.crypto.getRandomValues(t);let n="";for(let a=0;a<24;a++)n+=e[t[a]%e.length];const o=document.getElementById("new-password");if(o){o.value=n,o.type="text",He();const a=document.getElementById("toggle-new-password");a&&(a.innerHTML='<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path><line x1="1" y1="23" x2="23" y2="1"></line></svg>',a.style.color="var(--cyber-cyan)")}}function ht(){document.getElementById("cancel-add").addEventListener("click",()=>{U()}),document.getElementById("confirm-add").addEventListener("click",Me),document.getElementById("generate-pwd-btn")?.addEventListener("click",ft);const e=document.getElementById("toggle-new-password"),t=document.getElementById("new-password");e?.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation(),t&&(t.type==="password"?(t.type="text",e.innerHTML='<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path><line x1="1" y1="23" x2="23" y2="1"></line></svg>',e.style.color="var(--cyber-cyan)"):(t.type="password",e.innerHTML='<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>',e.style.color="var(--cyber-text-muted)"))}),t?.addEventListener("keydown",r=>{r.key==="Enter"&&(r.preventDefault(),Me())}),document.getElementById("download-protected-html-btn")?.addEventListener("click",async()=>{if(!N||!N.record){E("Notice","No active protected file session. Please select a file from the vault below to download.");return}const r=document.getElementById("download-protected-html-btn"),s=r?r.innerHTML:"";try{r&&(r.disabled=!0,r.innerHTML=`
...
`)||"Slide Content"})}let s=0;const c=document.createElement("div");c.className="ppt-viewer";const l=document.createElement("div");l.className="ppt-slide-card";const u=p=>{const g=i[p];l.innerHTML=`
      ...
      `,l.querySelector("#ppt-prev-btn")?.addEventListener("click",()=>{s>0&&(s--,u(s))}),l.querySelector("#ppt-next-btn")?.addEventListener("click",()=>{s<i.length-1&&(s++,u(s))})};u(0),c.appendChild(l),n.appendChild(c)}catch(o){console.warn("PPTX parsing fallback:",o),n.innerHTML=`
...
<body>
...
</html>`}}async function q(e,t=null){let n=null,o=t;if(t)try{const i=e.keys.find(r=>r.type==="password");i&&(n=await w.unwrapWithFallback(i.data,t,i.salt,i.iv))}catch{console.log("Provided password invalid for unlock")}if(!n){const i=await G("Decrypt for Export","Provide the ORIGINAL password to decrypt for export:",{inputType:"password",placeholder:"Enter password..."});if(!i)return null;try{const r=e.keys.find(s=>s.type==="password");n=await w.unwrapWithFallback(r.data,i,r.salt,r.iv),o=i}catch{return await E("Error","Incorrect password"),null}}return{buffer:await w.decryptData(n,e.iv,e.content),password:o}}async function Me(){const e=D.files[0],t=document.getElementById("new-password").value;if(!e){await E("Required","Please select a file to protect");return}if(!t){await E("Required","Protection password is required"),document.getElementById("new-password")?.focus();return}const n=document.getElementById("confirm-add"),o=n.innerText;n.innerText="SECURING FILE (6s)...",n.disabled=!0;const a=document.getElementById("protection-process-container"),i=document.getElementById("file-upload-zone"),r=document.getElementById("file-preview"),s=document.getElementById("inline-password-section"),c=document.getElementById("protection-complete-container"),l=document.getElementById("security-terminal-body"),u=document.getElementById("process-timer-display"),p=document.getElementById("scanner-status-text"),g=document.querySelector(".scanner-center-shield"),f=document.querySelector(".scanner-stage");i?.classList.add("hidden"),r?.classList.add("hidden"),s?.classList.add("hidden"),c?.classList.add("hidden"),a?.classList.remove("hidden"),f?.classList.add("rapid-scan"),["step-analysis","step-prep","step-kdf","step-encrypt","step-meta","step-finalize","step-output","step-verify"].forEach(h=>{x(h,"")}),g&&g.classList.remove("success"),p&&(p.textContent="SECURING"),l&&(l.innerHTML="");const y=Date.now(),v=setInterval(()=>{const h=Date.now()-y,B=Math.min(6e3,h),k=Math.floor(B/1e3).toString().padStart(2,"0"),C=Math.floor(B%1e3/10).toString().padStart(2,"0");u&&(u.textContent=`00:${k}.${C}`)},20),d=h=>{const B=Math.min(6e3,Math.max(0,h)),k=Math.floor(B/1e3).toString().padStart(2,"0"),C=Math.floor(B%1e3/10).toString().padStart(2,"0");return`[00:${k}.${C}]`},m=async h=>{const B=Date.now()-y,k=h-B;k>0&&await new Promise(C=>setTimeout(C,k))};try{F(14,"FILE STRUCTURE ANALYSIS // MEMORY ENCLAVE..."),x("step-analysis","active"),p&&(p.textContent="ANALYZING"),b(`${d(Date.now()-y)} INITIATING RAPID ENCRYPTION PIPELINE // ZERO-KNOWLEDGE V2.6`),b(`${d(Date.now()-y)} File: "${e.name}" [${te(e.size)}] | Type: ${e.type||"application/octet-stream"}`),b(`${d(Date.now()-y)} Enclave memory block allocated: ${e.size} bytes. Isolation confirmed.`);const h=w.detectDeviceCapabilities();b(`${d(Date.now()-y)} Hardware Profile: ${h.concurrency} Cores, ${h.memory}GB RAM [Worker Offload: Active]`),await m(750),x("step-analysis","completed"),F(28,"INITIALIZING CSPRNG ENTROPY POOL..."),x("step-prep","active"),p&&(p.textContent="ENTROPY POOL"),b(`${d(Date.now()-y)} Generating 256-bit cryptographic salt from hardware CSPRNG...`);const B=w.generateSalt(),k=await w.generateKey();b(`${d(Date.now()-y)} Nonce generation: 96-bit AES-GCM Initialization Vector created.`),b(`${d(Date.now()-y)} Ephemeral entropy validated: entropy score = 0.9998.`),await m(1500),x("step-prep","completed"),F(45,"DERIVING KEY (DUAL-STAGE KDF 2,000,000 ROUNDS)..."),x("step-kdf","active"),p&&(p.textContent="2,000,000 PBKDF2"),b(`${d(Date.now()-y)} Stage 1: HMAC-SHA512 Pre-whitening with Domain-Separated Pepper V6...`),b(`${d(Date.now()-y)} Worker Offload: Initializing background thread for smooth 60fps UI...`),b(`${d(Date.now()-y)} Stage 2: Computing 2,000,000 PBKDF2 iterations (Anti-JohnTheRipper / Anti-Hashcat)...`);const C=await w.deriveKeyAsyncWorker(t,B,2e6,w.MILSPEC_ANTI_CRACKER_PEPPER_V6);b(`${d(Date.now()-y)} Key derivation complete: 256-bit symmetric cipher key established.`),await m(2400),x("step-kdf","completed"),F(65,"AES-GCM-256 CIPHER STREAM PROCESSING..."),x("step-encrypt","active"),p&&(p.textContent="AES-256-GCM"),b(`${d(Date.now()-y)} Executing client-side WebCrypto AES-GCM 256-bit cipher...`);const H=await e.arrayBuffer(),Z=await w.computePayloadHash(H);b(`${d(Date.now()-y)} SHA-256 Payload Integrity Seal: ${Z.substring(0,16)}... [VERIFIED]`);const re=H.slice(0),{iv:xe,ciphertext:ae}=await w.encryptData(k,H);b(`${d(Date.now()-y)} Encrypting ${te(e.size)} payload blocks into zero-knowledge ciphertext...`),b(`${d(Date.now()-y)} Ciphertext generated (${ae.byteLength} bytes). 128-bit Galois Tag verified.`),await m(3300),x("step-encrypt","completed"),F(80,"PACKAGING ZERO-KNOWLEDGE METADATA..."),x("step-meta","active"),x("step-finalize","active"),p&&(p.textContent="KEY WRAP & VAULT"),b(`${d(Date.now()-y)} Wrapping master file key with AES key wrap cipher...`);const{iv:ie,wrappedData:We}=await w.wrapKey(k,C),$e=[{type:"password",salt:B,iv:ie,data:We}],Ie={id:crypto.randomUUID(),name:e.name,type:e.type,size:e.size,date:Date.now(),authMode:"always",keys:$e,content:ae,iv:xe,viewCount:0,expires:null,note:"",integrityHash:Z,accessLog:[{action:"created",date:Date.now()}]};await I.saveFile(Ie),b(`${d(Date.now()-y)} Encrypted container committed to zero-knowledge local IndexedDB.`),await m(4200),x("step-meta","completed"),x("step-finalize","completed"),F(92,"COMPILING STANDALONE HTML RUNTIME (.secure.html)..."),x("step-output","active"),p&&(p.textContent="STANDALONE HTML"),b(`${d(Date.now()-y)} Assembling self-contained portable decryption engine...`),b(`${d(Date.now()-y)} Embedding browser-native WebCrypto decryptor payload...`),b(`${d(Date.now()-y)} Anti-Exfiltration & Cryptographic defense matrix armed.`),await m(5100),x("step-output","completed"),F(100,"CRYPTOGRAPHIC INTEGRITY VERIFIED [SEALED]"),x("step-verify","active"),p&&(p.textContent="SEALING CONTAINER"),b(`${d(Date.now()-y)} Authenticity check: GMAC integrity tag valid. Zero-knowledge verification OK.`),b(`${d(Date.now()-y)} CRYPTOGRAPHIC CONTAINER LOCKED & SEALED. READY.`),await m(6e3),x("step-verify","completed"),clearInterval(v),u&&(u.textContent="00:06.00"),p&&(p.textContent="SECURED [✓]"),g&&g.classList.add("success"),await new Promise(Ve=>setTimeout(Ve,350)),f?.classList.remove("rapid-scan"),a?.classList.add("hidden"),c?.classList.remove("hidden");const ke=document.getElementById("complete-file-name");ke&&(ke.textContent=e.name),N={record:Ie,buffer:re,password:t},S()}catch(h){clearInterval(v),f?.classList.remove("rapid-scan"),console.error(h),b(`CRITICAL ERROR: ${h.message}`),await E("Error","Encryption failed: "+h.message),a?.classList.add("hidden"),r?.classList.remove("hidden"),s?.classList.remove("hidden")}finally{n.innerText=o,n.disabled=!1}}async function ye(e){if(!ze(e))try{const t=await I.getFile(e);if(!t){await E("Error","File not found");return}ve=t,document.getElementById("auth-file-name").innerText=t.name,V.showModal()}catch(t){console.error(t),await E("Error","Error opening file")}}async function Ne(){const e=ve;if(!e||ze(e.id))return;const t=document.getElementById("auth-password").value;if(!t)return;const n=document.getElementById("confirm-auth");n.innerText="Unlocking...";try{const o=e.keys.find(i=>i.type==="password");if(!o)throw new Error("Corrupt key data");const a=await w.unwrapWithFallback(o.data,t,o.salt,o.iv);Kt(e.id),V.close(),document.getElementById("auth-password").value="",qt(e,a)}catch(o){console.error(o),Ot(e.id),await E("Error","Incorrect password or decryption error.")}finally{n.innerText="Unlock"}}async function qt(e,t){try{const n=await w.decryptData(t,e.iv,e.content),o=new Blob([n],{type:e.type});M=URL.createObjectURL(o);const a=document.getElementById("viewer-content");a.innerHTML="";const i=Ee(e.name,e.type);z&&(i?(z.classList.remove("hidden"),z.onclick=()=>{if(!M)return;const d=document.createElement("a");d.style.display="none",d.href=M,d.download=e.name,document.body.appendChild(d),d.click(),document.body.removeChild(d)}):(z.classList.add("hidden"),z.onclick=null));const r=(e.name||"").toLowerCase(),s=(e.type||"").toLowerCase(),c=s.startsWith("image/")||/\.(jpg|jpeg|png|gif|webp|svg|bmp|ico)$/i.test(r),l=s.startsWith("video/")||/\.(mp4|webm|mov|mkv|ogg)$/i.test(r),u=s.startsWith("audio/")||/\.(mp3|wav|ogg|aac|m4a|flac)$/i.test(r),p=s==="application/pdf"||/\.pdf$/i.test(r),g=s.includes("excel")||s.includes("spreadsheet")||/\.(xlsx|xls|csv|tsv)$/i.test(r),f=s.includes("word")||/\.(docx|doc)$/i.test(r),y=s.includes("presentation")||s.includes("powerpoint")||/\.(pptx|ppt|pps|ppsx)$/i.test(r),v=s.startsWith("text/")||/\.(txt|json|js|ts|html|css|py|c|cpp|h|java|sh|xml|yaml|yml|sql|md|log|env|rs|go|kt|swift|rb|php)$/i.test(r);if(c){const d=document.createElement("img");d.src=M,d.style.maxWidth="90vw",d.style.maxHeight="80vh",d.style.objectFit="contain",a.appendChild(d)}else if(l||u){const d=document.createElement(l?"video":"audio");d.src=M,d.controls=!0,d.autoplay=!0,i||(d.setAttribute("controlsList","nodownload"),d.oncontextmenu=m=>m.preventDefault()),a.appendChild(d)}else if(p){const d=document.createElement("iframe");d.src=M+(i?"":"#toolbar=0"),d.style.width="100%",d.style.height="100%",d.style.border="none",a.appendChild(d)}else if(g)vt(n,a);else if(f)await Et(n,a);else if(y)await bt(n,e.name,a);else if(v){const m=new TextDecoder().decode(n),h=document.createElement("div");h.className="excel-viewer",h.style.background="#0f172a",h.style.color="#e2e8f0",h.innerHTML=`
    ...
    `,r.querySelector(".select-checkbox").onchange=m=>{m.stopPropagation(),m.target.checked?L.add(a.id):L.delete(a.id),j()},r.querySelector(".open-btn").onclick=m=>{m.stopPropagation(),ye(a.id)},r.querySelector(".download-btn").onclick=m=>$t(m,a.id),r.querySelector(".info-btn").onclick=m=>Ut(m,a.id),r.querySelector(".rename-btn").onclick=m=>Wt(m,a.id,a.name),r.querySelector(".share-btn").onclick=m=>Vt(m,a.id),r.querySelector(".custom-share-btn").onclick=m=>Gt(m,a.id),r.querySelector(".delete-btn").onclick=m=>_t(m,a.id),se.appendChild(r)})}function fe(){const e=localStorage.getItem("sv_panic_action")||"blur",t=document.getElementById("panic-action-select");t&&(t.value=e);const n=localStorage.getItem("sv_dl_media")!=="false",o=localStorage.getItem("sv_dl_doc")!=="false",a=document.getElementById("dl-media-toggle"),i=document.getElementById("dl-doc-toggle");a&&(a.checked=n),i&&(i.checked=o),me();const r=localStorage.getItem("sv_panic_enabled")!=="false",s=document.getElementById("panic-enable-toggle");s&&(s.checked=r),be()}function be(){const e=localStorage.getItem("sv_panic_enabled")!=="false",t=document.getElementById("header-panic-wrapper"),n=document.getElementById("panic-settings-content");t&&(e?(t.classList.remove("hidden"),t.style.display="flex"):(t.classList.add("hidden"),t.style.display="none")),n&&(e?(n.classList.remove("hidden"),n.style.opacity="1",n.style.pointerEvents="auto"):(n.classList.add("hidden"),n.style.opacity="0.5",n.style.pointerEvents="none"))}function he(){const e=localStorage.getItem("sv_panic_action")||"blur";if(e!=="none"){if(e==="erase")(async()=>{try{const t=localStorage.getItem("sv_panic_action"),n=await I.getAllFiles();for(const o of n)await I.deleteFile(o.id);localStorage.clear(),t&&localStorage.setItem("sv_panic_action",t),window.location.reload()}catch(t){console.error(t)}})();else if(e==="blur"||e==="lock"){ge(),_?.close(),ee?.close(),document.querySelectorAll(".panic-overlay").forEach(n=>n.remove());const t=document.createElement("div");t.className="panic-overlay blur-mode",t.innerHTML=`
    ...
    `,document.body.appendChild(t),document.getElementById("panic-reload-btn")?.addEventListener("click",n=>{n.stopPropagation(),t.remove()})}else if(e==="loading"){ge(),_?.close(),ee?.close(),document.querySelectorAll(".panic-overlay").forEach(o=>o.remove());const t=document.createElement("div");t.className="panic-overlay",t.innerHTML=`
